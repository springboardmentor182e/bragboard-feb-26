  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        <SidebarItem icon={<LayoutDashboard size={18} />} label="Dashboard" to="/" end />
        <SidebarItem icon={<Trophy size={18} />} label="Achievements" />
        <SidebarItem icon={<Megaphone size={18} />} label="My Shoutouts" to="/my-shoutouts" />
...
const SidebarItem = ({ icon, label, active, to, end }) => {
