...
// Demo credentials
const EMPLOYEE_CREDENTIALS = { email: "john.doe@company.com", password: "employee123" };
const ADMIN_CREDENTIALS = { email: "admin@prackboard.com", password: "admin123" };
...
export default function PrackBoardAuth() {
  ...
  const handleSubmit = () => {
    ...
    const creds = isAdmin ? ADMIN_CREDENTIALS : EMPLOYEE_CREDENTIALS;
    ...
    <>
      ...
      <div className="auth-wrapper">
        <div className={`card ${isAdmin ? "admin-mode" : ""}`}>
          ...
          {/* Title */}
          <div className="card-title">{isAdmin ? "Admin Portal" : "Welcome to PrackBoard"}</div>
